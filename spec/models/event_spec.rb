...
RSpec.describe Event, type: :model do
  ...
  it "should not allow two events to have the same title" do
    event1 = Event.create(title: "Jardin", location: "Roma", date: "2024-09-21", price: 15, organizer_id: 3,status: "published")
    event2 = Event.new(title: "Jardin", location: "Milano", date: "2024-09-21", price: 20, organizer_id: 3,status: "published")
  ...
  it "should not allow two events to have the same date and location" do
    ...
    event2 = Event.new(title: "Festa Roma", location: "Roma", date: "2024-09-21", price: 20, organizer_id: 2,status: "published")
