...
RSpec.describe Event, type: :model do
  ...
  it "should be invalid without a title" do
    event = Event.new(location: "Roma", date: "2023-07-31", price: 15, organizer_id: 1,status: "published")
    expect(event).not_to be_valid
  ...
  it "should be invalid without e a location" do
    event = Event.new(title: "Jardin", date: "2023-07-31", price: 15, organizer_id: 1,status: "published")
    expect(event).not_to be_valid
  ...
  it "should be invalid without a price" do
    event = Event.new(title: "Jardin", location: "Roma", date: "2023-07-31", organizer_id: 1,status: "published")
    expect(event).not_to be_valid
  ...
  it "should be invalid without  an organizer" do
    event = Event.new(title: "Jardin", location: "Roma", date: "2023-07-31", price: 15,status: "published")
    expect(event).not_to be_valid
    expect(event.errors[:organizer_id]).to include("can't be blank")
  end
  it "should not allow two events to have the same title" do
    event1 = Event.create(title: "Jardin", location: "Roma", date: "2023-07-31", price: 15, organizer_id: 3,status: "published")
    event2 = Event.new(title: "Jardin", location: "Milano", date: "2023-08-15", price: 20, organizer_id: 3,status: "published")

    expect(event2).not_to be_valid
    expect(event2.errors[:title]).to include("has already been taken")
  end

  it "should not allow two events to have the same date and location" do
    event1 = Event.create(title: "Jardin Roma", location: "Roma", date: "2023-07-31", price: 15, organizer_id: 1,status: "published")
    event2 = Event.new(title: "Festa Roma", location: "Roma", date: "2023-07-31", price: 20, organizer_id: 2,status: "published")
  ...
  it "should have default limit value of 100" do
    event = Event.create(title: "Jardin", location: "Roma", date: "2023-07-31", price: 15, organizer_id: 1,status:"published")
  ...
  it "should have presales_left equal to limit by default" do
    event = Event.create(title: "Jardin", location: "Roma", date: "2023-07-31", price: 15, organizer_id: 1,status:"published",limit:50)
    expect(event.presales_left).to eq(event.limit)
    puts event.presales_left
  end
  ...
  it "should not save event organized by simple user" do
    ...
    event=Event.new(title: "Jardin", location: "Roma", date: "2023-07-31", price: 15, organizer_id: 6,status:"published",limit:50)
    expect(event).not_to be_valid
  end
  ...
  it "should save event organized by admin" do
    ...
    event=Event.new(title: "Jardin", location: "Roma", date: "2023-07-31", price: 15, organizer_id: 1,status:"published",limit:50)
